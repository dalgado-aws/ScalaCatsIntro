...
object WorkWithMappable extends  App {
  ...
  println("processing option", changeContainerContentsForAnyMappable(Option("hello")))

  println("processing list", changeContainerContentsForAnyMappable(List(1,2,3)))

  println("processing custom container", changeContainerContentsForAnyMappable(new Container("hello")))
